...
import DetailFace from './DetailFace';

const Facewash = () => {
    return (
          <div> 
        <Link to='/' className='flex lg:flex-row flex-col justufy-around bg-black text-yellow-50'>
            <div className=" flex-1 lg:w-96 w-64 h-full p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
	<img src="https://i.ibb.co/XDrS6xt/istockphoto-1287548628-170667a.webp" alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
	<div className="space-y-4 text-center divide-y divide-gray-700">
		<div className="my-2 space-y-1">
			<h2 className="text-xl font-semibold sm:text-2xl">Lee Jankuk</h2>
			<p className="px-5 text-xs sm:text-base dark:text-gray-400">Beautysian of Korea</p>
		</div>
		<div className="flex justify-center pt-2 space-x-4 align-center">
           ...
           <div
  class="relative flex-1 w-screen max-w-sm border border-gray-600 bg-gray-100 px-4 py-8 sm:px-6 lg:px-8"
  aria-modal="true"
  role="dialog"
  tabindex="-1"
>
