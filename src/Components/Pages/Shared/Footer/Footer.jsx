...
<footer class="bg-black text-white">
  <div class="mx-auto px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md">
      ...
      >
        Want us to email you with the latest Skincare Products?
      </strong>
    ...
    <div class="mt-16 border-t border-gray-100 pt-8">
      <p class="text-center text-xs/relaxedtext-white">
        ...
        <a
          href=""
          class="text-white transition ml-2 mr-2 hover:text-white/75"
          >Korean</a
        >
        and
        <a
          href=""
          class="text-white transition ml-2 hover:text-white/75"
          >Skincare</a>
      </p>
    </div>
  </div>
